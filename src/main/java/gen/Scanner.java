		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					{t.kind = 1; break loop;}
				case 3:
					if (ch == 'A') {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 4:
					if (ch == 'D') {AddCh(); state = 5; break;}
					else {state = 0; break;}
				case 5:
					if (ch == 'I') {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
				...
				case 11:
					if (ch == 'K') {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
					if (ch == 'B') {AddCh(); state = 13; break;}
					else {state = 0; break;}
				case 13:
				...
				case 15:
					{t.kind = 3; break loop;}
				case 16:
					if (ch == 'E') {AddCh(); state = 17; break;}
					else {state = 0; break;}
				case 17:
					if (ch == 'X') {AddCh(); state = 18; break;}
					else {state = 0; break;}
				case 18:
					if (ch == 'T') {AddCh(); state = 19; break;}
					else {state = 0; break;}
				case 19:
					if (ch == 'B') {AddCh(); state = 20; break;}
					else {state = 0; break;}
				case 20:
					if (ch == 'O') {AddCh(); state = 21; break;}
					else {state = 0; break;}
				case 21:
					if (ch == 'X') {AddCh(); state = 22; break;}
					else {state = 0; break;}
				case 22:
					{t.kind = 4; break loop;}
				case 23:
